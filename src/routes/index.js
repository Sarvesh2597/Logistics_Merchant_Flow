...
const signupConfirm = React.lazy(() => import('../pages/auth/signupConfirm'));
// dashboard
const Dashboard = React.lazy(() => import('../pages/dashboard'));
const createOrder = React.lazy(() => import('../pages/createOrder/Order'));
const ViewOrder = React.lazy(() => import('../pages/ViewOrder/vOrder'));
const Vendors = React.lazy(() => import('../pages/Vendors/Vendor'));
const EditOrder = React.lazy(() => import('../pages/EditOrder'));
const EditSettings = React.lazy(() => import('../pages/EditSettings'));
// apps
