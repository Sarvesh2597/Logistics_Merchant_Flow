...
import { Number, DollarSign, Shield } from 'react-feather';
                                        ...
                                        <CardBody className="p-0">
                                            <Row>
                                                <Col md={6} className="p-5 position-relative">
                                                    ...
                                                    <h6 className="h5 mb-0 mt-4">OTP Confirmation</h6>
                                                    <p className="text-muted mt-1 mb-4">
                                                        Enter the OTP sent on your email to reset your password.
                                                    </p>
                                                    ...
                                                    <AvForm
                                                        ...
                                                        <AvGroup className="">
                                                            <Label for="email">Enter the 4-digit OTP</Label>
                                                            <InputGroup>
